...
| Context | any multi-component/repository work | seed context, ownership, dependencies, blast radius and write boundary recorded | Lead |
...
Data, Performance, Platform, Accessibility, Compliance, Mainframe, or domain gates may be added by project configuration. Their applicability must be decided from risk, not from whether a specialist happens to be available.
