...
`Question → Context → Quality attributes → Options → Risk reviews → Decision → Governance record`
...
3. Compare credible options against requirements, cost, risk, operability, migration, and exit strategy.
4. Request Security, Reliability, Data, Performance, Platform, or domain review according to triggers.
5. Record the decision and consequences in an ADR; use C4 or other diagrams only where they improve shared understanding.
6. Identify follow-up implementation or migration demands separately.
