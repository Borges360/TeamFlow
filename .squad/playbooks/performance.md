---
{"schema_version":"1.0","id":"performance","version":"1.0","aliases":["perf"],"workflow":"performance-audit","side_effect_class":"conditional-write","permissions":{"requires_repository_read":true,"may_write_files":true,"may_create_local_branch":true,"may_push":false,"may_merge":false,"may_deploy":false,"may_release":false,"may_delete":false}}
---
...
## When to use
Use `/performance <question>` when performance is the principal measurable outcome.
## Do not use when
